...
<body>
    ...
    <form method="post">
        ...
        <table>
            <tr>
                <td colspan="2" style="text-align: center; padding: 30px; font-size: 20px;"><strong>Student Information:</strong></td>
            </tr>
            ...
            <tr>
                ...
                <td>What School Graduated? <strong>(Enter Full School Name)</strong><input type="text" name="s_past_school" required></td>
            </tr>
            ...
            <tr>
                <td colspan="2" style="text-align: center; padding: 30px; font-size: 20px;"><strong>Mother Information:</strong></td>
            </tr>
            ...
            <tr>
                <td colspan="2" style="text-align: center; padding: 30px; font-size: 20px;"><strong>Father Information:</strong></td>
            </tr>
            ...
            <tr>
                <td colspan="2" style="text-align: center; padding: 30px; font-size: 20px;"><strong>Guardian Information (Optional):</strong></td>
            </tr>
        ...
        <button type="submit" name="submit_admin">Submit</button>

        <button class="btn-bottom" onclick="window.location.href='dashboard.php'">Back</button>
    </form>
